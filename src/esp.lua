...
local esp = {
    ...
    -- instances
    --\ @teammates
    team_chams = {true,Color3.fromRGB(255, 255, 255),Color3.fromRGB(138, 139, 194),.25,.75,true},
    --
    team_boxes = {true,Color3.fromRGB(255,255,255),Color3.fromRGB(1,1,1),0},
    team_healthbar = {true, Color3.new(0,255,0), Color3.new(255,0,0)},
    team_kevlarbar = { false, Color3.new(), Color3.new() },
    team_arrow = {false, Color3.new(255,255,255), 0.5},
    --
